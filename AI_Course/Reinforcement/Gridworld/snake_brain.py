...
class Brain:
    ...
    def check_row(self, row, head_index, tail):
        ...
        if side[0]:
            if side[1]:
                if head_index + 1 == self.board_count or \
        ...
        if x < 0 and y < 0:
            if head_dir == "↓":
                if hi_x == 0 or board[hi_y][hi_x-1] == TAIL:
                    if hi_y == self.board_count - 1 or \
                            board[hi_y+1][hi_x] == TAIL:
                        next_move = "→"
                    else:
                        pass
                else:
                ...
                if hi_y == 0 or board[hi_y-1][hi_x] == TAIL:
                    if hi_x == self.board_count - 1 or \
                            board[hi_y][hi_x+1] == TAIL:
                        next_move = "↓"
                    else:
                        pass
                else:
            ...
            if head_dir == "↑":
                if hi_x == 0 or board[hi_y][hi_x - 1] == TAIL:
                    if hi_x == self.board_count - 1 or \
                        ...
                        next_move = "→"
                elif hi_x == self.board_count - 1 or \
                        board[hi_y][hi_x + 1] == TAIL:
                    next_move = "←"
                else:
                    next_move = self.check_row(board[hi_y], hi_x, tail)
            ...
            if head_dir == "←":
                if hi_y == 0 or board[hi_y - 1][hi_x] == TAIL:
                    if hi_y == self.board_count - 1 or \
                        ...
                        next_move = "↓"
                elif hi_y == self.board_count - 1 or \
                        board[hi_y + 1][hi_x] == TAIL:
                    next_move = "↑"
                else:
                    col = np.transpose(board)
